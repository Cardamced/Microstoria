...
const SingleFileUploader: React.FC<SingleFileUploaderProps> = ({
  ...
  previewMaxWidth = 150, // Valeur par défaut
  previewMaxHeight = 150, // Valeur par défaut
}) => {
  ...
  return (
    <>
      ...
      {file && !isShut && (
        <section className="conteneur-détails-image">
          <ul>
            <li>Nom: {file.name}</li>
              ...
              {showPreview && (
                <div 
                  ...
                  style={{
                    ...
                    right: '10px',
                    zIndex: 50,
                    width: `${previewMaxWidth /2}px`,
                    height: `${previewMaxHeight /2}px`,
                    display: 'flex',
